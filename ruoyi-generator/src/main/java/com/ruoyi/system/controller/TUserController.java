...
public class TUserController extends BaseController
{
     ...
     * 查询用户列表
     */
    @PreAuthorize("@ss.hasPermi('jingyes:user:list')")
    @GetMapping("/list")
     ...
     * 导出用户列表
     */
    @PreAuthorize("@ss.hasPermi('jingyes:user:export')")
     ...
     * 获取用户详细信息
     */
    @PreAuthorize("@ss.hasPermi('jingyes:user:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增用户
     */
    @PreAuthorize("@ss.hasPermi('jingyes:user:add')")
     ...
     * 修改用户
     */
    @PreAuthorize("@ss.hasPermi('jingyes:user:edit')")
     ...
     * 删除用户
     */
    @PreAuthorize("@ss.hasPermi('jingyes:user:remove')")
