<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="ID" align="center" prop="electricalId" width="80" />
      ...
      <el-table-column label="L1相电压(V)" align="center" prop="voltageL1" width="120" />
      <el-table-column label="L2相电压(V)" align="center" prop="voltageL2" width="120" />
      <el-table-column label="L3相电压(V)" align="center" prop="voltageL3" width="120" />
      <el-table-column label="有功功率(kW)" align="center" prop="activePower" width="120" />
      <el-table-column label="功率因数" align="center" prop="powerFactor" width="100" />
      <el-table-column label="效率(%)" align="center" prop="efficiency" width="100" />
      <el-table-column label="电器等级" align="center" prop="electricalGrade" width="100">
        <template slot-scope="scope">
