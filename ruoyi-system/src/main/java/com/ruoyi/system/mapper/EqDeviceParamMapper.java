...
public interface EqDeviceParamMapper 
{
     ...
     * @return 设备参数
     */
    public EqDeviceParam selectEqDeviceParamByParamId(@Param("paramId") Long paramId);
     ...
     * @return 结果
     */
    public int deleteEqDeviceParamByParamId(@Param("paramId") Long paramId);
     ...
     * @return 结果
     */
    public int deleteEqDeviceParamByParamIds(@Param("paramIds") Long[] paramIds);
